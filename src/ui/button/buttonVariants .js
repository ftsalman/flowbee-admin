     ...
     "text-sm font-medium rounded-lg flex cursor-pointer items-center justify-center gap-2 border border-transparent transiton-colors duration-300 disabled:cursor-not-allowed outline-0",
  {
    variants: {
      variant: {
        ...
        "brand-primary":
          "text-black bg-[#FFC830] hover:opacity-90 focus:ring-[3px] focus:ring-brand-primary-200 focus:border-brand-primary-600 disabled:bg-gray-200 disabled:text-gray-400",
        "brand-secondary":
